...
나리타공항에서 도쿄 도심으로 이동, 게이세이 스카이라이너를 타기로 했습니다. 도쿄역을 거칠 것 없이 우에노역에서 바로 신칸센 타고 올라가려고 했기 때문입니다. 그리고 이게 더 싸더라고요. 
...
열차 가는 것까지 다 보고 플랫폼에서 에스컬레이터 타고 올라가면서 깨달았습니다. 저 신칸센에 가방을 놓고 내렸다는 것을요. 어쩐지 등이 허전하더라. 
